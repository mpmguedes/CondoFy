...
function casca(html) {
  return {
    ...
    logotipo: /class="auth-logo"[\s\S]{0,160}?src="\/img\/gescondu_logo_final\.svg"/.test(html),
...
function testarPaginasDeConta() {
  ...
  for (const [ficheiro, titulo] of vistas) {
    ...
    assert.ok(v.includes('src="/img/gescondu_logo_final.svg"'), `${ficheiro}: logótipo sobre fundo escuro (o mesmo da entrada)`);
